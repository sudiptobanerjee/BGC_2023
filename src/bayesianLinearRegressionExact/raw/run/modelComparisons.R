## ----waic_demonstration, message=FALSE, warning=FALSE-------------------------
# -----------------------------------------------------------------------------
...
## ----sequential_model_comparison, message=FALSE, warning=FALSE, fig.width=10, fig.height=7----
library(ggplot2)
library(dplyr)
library(tidyr)
...
## ----waic_trajectory_plot, message=FALSE, warning=FALSE, fig.width=10, fig.height=5.5----
# -----------------------------------------------------------------------------
