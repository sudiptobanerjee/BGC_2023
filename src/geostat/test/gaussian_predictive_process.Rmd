---
title: "Predictive Process Example with spBayes"
...
```{r conduct spatial interpolation using akima and mba packages}
...
```{r visualize_predictions_akima, fig.width=8, fig.height=6}
...
```{r visualize_predictions_mba, fig.width=8, fig.height=6}
